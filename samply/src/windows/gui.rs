...
fn run_inner() -> w::AnyResult<i32> {
    ...
    let record_btn = gui::Button::new(&wnd, gui::ButtonOpts {
    ...
    let configure_btn = gui::Button::new(&wnd, gui::ButtonOpts {
    ...
    let providers_label = gui::Label::new(&wnd, gui::LabelOpts {
        text: "Providers:",
        position: (15, 96),
        size: (100, 20),
        window_style: hidden,
    ...
    let browsers_check = gui::CheckBox::new(&wnd, gui::CheckBoxOpts {
        text: "Browsers",
        position: (25, 120),
        size: (150, 20),
    ...
    let graphics_check = gui::CheckBox::new(&wnd, gui::CheckBoxOpts {
        text: "Graphics",
        position: (25, 145),
        size: (150, 20),
        window_style: co::WS::CHILD | co::WS::GROUP | co::WS::TABSTOP,
    ...
    let symbols_label = gui::Label::new(&wnd, gui::LabelOpts {
        text: "Symbols:",
        position: (15, 175),
        size: (100, 20),
        window_style: hidden,
    ...
    let symbols_server_check = gui::CheckBox::new(&wnd, gui::CheckBoxOpts {
    ...
    let mozilla_server_check = gui::CheckBox::new(&wnd, gui::CheckBoxOpts {
